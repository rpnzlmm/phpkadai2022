...
<html lang="ja">
    ...
    <body>
        レシピの投稿<br>
        <form method="post" action="uppdate.php?id=
        ...
        <br>
        難易度：
        <input type="radio" name="difficulty" value="1" <?php if ($result['difficulty'] == 1) echo 'cheked' ?>>簡単
        <input type="radio" name="difficulty" value="2" <?php if ($result['difficulty'] == 2) echo 'cheked' ?>>普通
        <input type="radio" name="difficulty" value="3" <?php if ($result['difficulty'] == 3) echo 'cheked' ?>>難しい
        <br>
        予算：
